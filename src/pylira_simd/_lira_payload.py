...
class LiraPayload:
    ...
    def __init__(self, observation: Union[str, npt.NDArray[np.number]], baseline: Union[str, npt.NDArray[np.number]],
                 psf: Union[str, npt.NDArray[np.number]], out_img_file: str, out_param_file: str, alpha_init: npt.NDArray[np.number] = None, max_iter: int = 3000, thin: int = 1, burn_in: int = 1000, exp_map: Union[str, npt.NDArray[np.number]] = None, start_map: Union[str, npt.NDArray[np.number]] = None, fit_bkgscl: bool = True, ms_ttlcnt_pr: float = 1.0, ms_ttlcnt_exp: float = 0.05, ms_al_kap1: float = 0.0, ms_al_kap2: float = 1000.0, ms_al_kap3: float = 3.0, use_float: bool = False, use_prag_bayesian_psf: bool = False) -> None:
