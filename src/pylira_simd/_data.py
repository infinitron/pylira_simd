...
def _read_sample_fits(file_name):
    ...
    with importlib_resources.as_file(pkg / "sample_data" /
                                     file_name) as img_path:
...
def get_sample_images():
    ...
    return _dotdict(
        dict(img_64x64=_img_64x64_dat,
             psf_33x33=_psf_33x33,
             baseline_64x64=_baseline_64x64,
             expmap_64x64=_expmap_64x64,
             start_64x64=_start_64x64))
